...
CHECK_LOGISTICS_URL = BASE_URL + "/coupApply/cms/checkLogisticsStatus"
...
response = requests.post(CHECK_LOGISTICS_URL, json=check_data, headers=headers)
...
print(f"\n📊 物流状态: {status_map.get(str(status), '未知状态')}")
